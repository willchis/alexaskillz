...
@ask.launch
def launched():
    return question("This is a surf forecast skill for rest bay, porth call, South Wales.  Would you like today's surf report?").reprompt("I didn't get that. Would you like the current conditions?")
